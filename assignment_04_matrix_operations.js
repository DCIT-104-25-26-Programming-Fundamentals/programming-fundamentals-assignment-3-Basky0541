...
function main() {
    ...
    let matrixMulA = readMatrix(m, n, "Matrix A");
    ...
    let matrixMulB = readMatrix(n2, p, "Matrix B");

    let productMatrix = multiplyMatrices(matrixMulA, matrixMulB);
